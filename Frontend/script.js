...
function getUsers() {
  // Prefer cached users stored in localStorage by the login/register flow.
...
async function loginUser(form) {
  ...
  localStorage.setItem("ssdAuthToken", data.token);
  // Cache user in localStorage to keep the existing profile UI working
  saveCurrentUser(data.user);
